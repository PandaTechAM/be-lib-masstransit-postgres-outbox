  ...
  public bool Equals(ComplexObjectEvent other)
{
    ...
    {
        Console.WriteLine($"Mismatch in StringList: {string.Join(", ", StringList ?? Enumerable.Empty<string>())} != {string.Join(", ", other.StringList ?? Enumerable.Empty<string>())}");
        isMatch = false;
    }
...
public class NestedObject
{
   ...
   {
      if (obj is not NestedObject other) return false;
