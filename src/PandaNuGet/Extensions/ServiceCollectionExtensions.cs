...
namespace MassTransit.PostgresOutbox.Extensions
{
   ...
   {
      public static IServiceCollection AddOutboxInboxServices<TDbContext>(this IServiceCollection services, Settings settings = null!)
      ...
      public static IServiceCollection AddOutboxPublisherJob<TDbContext>(this IServiceCollection services, Settings settings = null!)
      ...
      public static IServiceCollection AddOutboxRemovalJob<TDbContext>(this IServiceCollection services, Settings settings = null!)
       where TDbContext : DbContext, IOutboxDbContext
      {
         services.AddSettings(settings);
      ...
      public static IServiceCollection AddInboxRemovalJob<TDbContext>(this IServiceCollection services, Settings settings = null!)
